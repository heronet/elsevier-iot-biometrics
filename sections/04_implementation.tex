...
\hline
Typical Config & $<$ \SI{5}{\kilo\byte} & $<$ \SI{150}{\byte} & $<$ \SI{1}{\kilo\byte} \\
\hline
\end{tabularx}
\vspace{2pt}
\footnotesize{\\ \textit{Note: GT-5X uses dynamic allocation for packet buffers; ZFM-X0 uses static buffers.}}
\end{table}

\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figs/fig_memory.pdf}
    \caption{Memory footprint breakdown for ZFM-X0 and GT-5X drivers, illustrating Flash, Static RAM, and Heap utilization.}
